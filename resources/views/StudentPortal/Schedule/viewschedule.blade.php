                                            ...
                                            @foreach($data as $data)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                            ...
                                                            @elseif($data -> reservation_emo_status == 2)
                                                    ...
                                                    <td>
                                                        <div class="btn-group-vertical">
                                                            ...
                                                            @if( date('Y-m-d h:i A', strtotime($data->reservation_end)) > date('Y-m-d h:i A') && date('Y-m-d h:i A', strtotime($data->reservation_start)) < date('Y-m-d h:i A')  )
